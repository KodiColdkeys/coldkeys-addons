...
#                    print 'item link', item('link')
                    ...
                    for i in item('utube'):
                        if not i.string == None:
                            ...
                            elif i.string.endswith("|"):
                                if  i.string.startswith('PL'):
                                    utube = 'plugin://plugin.video.youtube/playlist/' + i.string[:-1] + '/'
                                else:
                                    utube = 'plugin://plugin.video.youtube/channel/' + i.string[:-1] + '/'
                            elif '|' in i.string:
                               channel, playlist = i.string.split("|")
                               utube = 'plugin://plugin.video.youtube/channel/' + channel + '/playlist/' + playlist + '/'
...
if mode==None:
    ...
    elif not url.startswith("plugin://plugin") or not any(x in url for x in g_ignoreSetResolved):#not url.startswith("plugin://plugin.video.f4mTester") :
